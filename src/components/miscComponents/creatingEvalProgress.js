...
class CreatingEvalProgress extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const amountDone = time / NUM_HOURS;
        ...
        return (
            <div
                className={"onboarding-progress-container creatingEval"}
...
export default connect(mapStateToProps, mapDispatchToProps)(CreatingEvalProgress);
