...
class BusinessSignup extends Component {
    ...
    componentDidMount() {
        ...
        try {
            ...
            // the chatbot
            if (!email || !name || !company || !positionTitle || !positionType) {
                return goTo("/chatbot");
            }
        } catch (e) {
            return goTo("/chatbot");
        } // go to chatbot on error
        ...
        return (
            <div className="fillScreen formContainer business-signup">
                <MetaTags>
                    ...
                    <meta
                        name="description"
                        content="Create an account for your business. Moonshot helps you find the best candidates possible. Don't waste resources on any bad hires."
                    />
                </MetaTags>
                <div>
                    ...
                    <div className="form lightBlackForm" style={{ marginTop: "10px" }}>
                        {this.state.email != "" && this.props.userPosted ? (
                            <div className="center">
                                ...
                                <p style={{ margin: "20px" }}>
                                    We sent {this.state.email} a verification link. Check your junk
                            ...
                            <div>
                                <form onSubmit={this.handleSubmit.bind(this)}>
                                    <div
                                        ...
                                        className="primary-cyan font28px font24pxUnder500"
                                    >
                                        Try us out for your <br />
                                        {`${this.state.positionTitle} position`}
                                    </div>
                                    ...
                                    <div style={{ margin: "20px 20px 10px" }} className="font12px">
                                        ...
                                        >
                                            <img
                                                ...
                                                src={
                                                    "/icons/CheckMarkRoundedWhite" + this.props.png
                                                }
                                            />
                                        </div>
