...
class ReferralCode extends Component {
    ...
    handleSubmit(e) {
        ...
        if (!this.state.agreeingToTerms) {
            this.props.addNotification(
                "Must agree to Affiliate Agreement, Terms of Use, and Privacy Policy.",
                "error"
            );
            return;
        }
        ...
        axios
            .post("/api/misc/createReferralCode", { name, email })
    ...
    render() {
        ...
        const actionsAA = [
            <FlatButton label="Close" primary={true} onClick={this.handleCloseAA} />
        ];
        let blurredClass = "";
        ...
        return (
            <div className="fillScreen formContainer">
                <MetaTags>
                    ...
                    <meta
                        name="description"
                        content="Become a Moonshot referrer and get $300 for every friend that gets a job through us!"
                    />
                </MetaTags>
                    ...
                    <div className="form" style={{ padding: "10px 20px" }}>
                        {this.state.referralCode ? (
                            <div className="primary-cyan">
                                ...
                                >
                                    {"https://moonshotinsights.io/?referralCode="}
                                    {this.state.referralCode}
                                </span>
                                <br />
                                <span className="font16px">
                                    Have your friend enter this code when they finish a pathway or
                                    use that url when they sign up. If they get the job, we{"'"}ll
                                    send you $300 through PayPal. We sent you an email with your
                                    code and some extra info.
                                </span>
                            </div>
                        ) : (
                            <form onSubmit={this.handleSubmit.bind(this)}>
                                <span className="font24px">
                                    Earn $300 for every friend that <br />gets a job through
                                    Moonshot.
                                </span>
                                <br />
                                ...
                                <div style={{ margin: "20px 20px 10px" }} className="primary-cyan">
                                    ...
                                    <bdi
                                        className="clickable primary-cyan"
                                        onClick={this.handleOpenAA}
                                    >
