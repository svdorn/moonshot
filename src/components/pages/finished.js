    ...
    createContent() {
        ...
        return (
            <div>
                ...
                <div styleName="text">
                    <div>
                        Thank you for taking the time to finish your evaluation! Your results have been saved and are being reviewed by {companyName}. You can now safely exit this tab.
                    </div>
                </div>
            </div>
        );
