    ...
    makeFrame2() {
        return (
            <div className="center">
                ...
                <button
                    className="button gradient-transition inlineBlock gradient-1-cyan gradient-2-purple-light round-4px font16px font14pxUnder900 primary-white marginTop20px"
        ...
        return (
            <div className="center">
                ...
                {this.props.loadingCreateBusiness ? (
                    ...
                    <button
                        className="button gradient-transition inlineBlock gradient-1-cyan gradient-2-purple-light round-4px font16px font14pxUnder900 primary-white"
