...
const descriptions = {
    Dimension: {
        left: `Those who score farther to the left on this scale (L) tend to be more reserved, but have hidden depths. They are relied upon to fill crucial support roles that leader-types cannot. While they may shy away from social situations, it’s because they thrive best on their own.`,
    ...
    Viewpoint: {
        left: `Those who score farther to the left (L) are often seen as hard-hearted or callous. But they too understand others’ plights, even if they sometimes choose not to express it. They are able to make the hard decisions that others cannot bring themselves to make.`,
        right: `Those who score farther to the right (R) show a lot of sympathy towards others. They always understand others’ plights and will do what they can to help them, but as a result, they struggle with saying or doing things that may hurt others, especially emotionally, even if it’s the right thing to do.`,
    },
    Methodology: {
    ...
    Belief: {
        ...
        right: `Those who score farther to the right (R) are often seen as brutally honesty. They will say what needs to be said, even if others don’t want to hear it. They are real will with people and will always follow the rules. They dislike individuals who are fake and those who take advantage of others.`,
    }
}
